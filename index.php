...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>The</strong>Death</a>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p class="text">The Doctor Van Anh very beautiful</p>
        </div>
        ...
        <div class="box">
            ...
            <p class="text">Hiến máu đi các bạn</p>
        </div>
        ...
        <div class="box">
            ...
            <p class="text">Quân tử không đấu với tiểu nhân, kẻ ác tất có kẻ ác trị.</p>
        </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-envelope"></i> cukhuckhac15cm@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> nemdagiautay@gmail.com </a>
    ...
    <div class="credit"> <span> &#169;KDIL</span> | all rights reserved </div>
